<template>
  <div id="company-skills">
    <div class="vd_content-wrapper">
      <div class="vd_content clearfix">
        <div class="vd_title-section clearfix">
          <div class="vd_panel-header">
            <h1><i class="fa fa-keyboard"></i> Company Skills</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="vd_content-section clearfix">
			...
			<div class="row mrgn15-0">
				...
				<div class="col-md-4">
						<button type="button" class="btn vd_btn vd_bg-blue btn-lg btn-block" data-toggle="modal" data-target="#addCompany"><span class="append-icon"><i class="fa fa-plus-square"></i></span>Add New Skill</button>
				</div>
				<div class="col-md-4"></div>
			</div>
